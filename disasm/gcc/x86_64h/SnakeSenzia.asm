...
## %bb.36:
	...
	vfmadd213ss	(%rcx), %xmm1, %xmm0    ## xmm0 = (xmm1 * xmm0) + mem
	vmovss	4(%rcx), %xmm1                  ## xmm1 = mem[0],zero,zero,zero
	callq	__ZN2sf13Transformable11setPositionEff
	movq	160(%r12), %rbx
	cmpq	168(%r12), %rbx
...
LBB20_67:
	...
	vfmadd213ss	%xmm0, %xmm3, %xmm1     ## xmm1 = (xmm3 * xmm1) + xmm0
	vmovaps	%xmm2, %xmm0
	...
	vfmadd231ss	4(%rax), %xmm0, %xmm1   ## xmm1 = (xmm0 * mem) + xmm1
	movq	%rbx, %rdi
...
LBB23_42:
	...
	vfmadd213ss	LCPI23_3(%rip), %xmm2, %xmm1 ## xmm1 = (xmm2 * xmm1) + mem
	...
	vfmadd231ss	LCPI23_4(%rip), %xmm2, %xmm0 ## xmm0 = (xmm2 * mem) + xmm0
	vfmadd231ss	LCPI23_5(%rip), %xmm1, %xmm0 ## xmm0 = (xmm1 * mem) + xmm0
	vsubps	%xmm1, %xmm2, %xmm1
	vmovshdup	%xmm1, %xmm1            ## xmm1 = xmm1[1,1,3,3]
	vmovss	-56(%rbp), %xmm2                ## 4-byte Reload
                                        ## xmm2 = mem[0],zero,zero,zero
	vfmadd132ss	LCPI23_6(%rip), %xmm2, %xmm1 ## xmm1 = (xmm1 * mem) + xmm2
	movq	16(%rbx), %rdi
	addq	$8, %rdi
	callq	__ZN2sf13Transformable11setPositionEff
	movl	$32, %edi
...
LBB23_45:
	...
	vmovss	-48(%rbp), %xmm0                ## 4-byte Reload
                                        ## xmm0 = mem[0],zero,zero,zero
	vsubss	%xmm1, %xmm0, %xmm0
	vmovss	LCPI23_0(%rip), %xmm3           ## xmm3 = mem[0],zero,zero,zero
	...
	vfmadd213ss	LCPI23_7(%rip), %xmm3, %xmm1 ## xmm1 = (xmm3 * xmm1) + mem
	vmovss	%xmm1, -56(%rbp)                ## 4-byte Spill
	movq	8(%rbx), %rdi
	addq	$8, %rdi
	callq	__ZN2sf13Transformable11setPositionEff
...
LBB52_5:
	...
	vfmadd231ps	%xmm2, %xmm1, %xmm0     ## xmm0 = (xmm1 * xmm2) + xmm0
	vmovlps	%xmm0, -56(%rbp)
	vxorps	%xmm1, %xmm1, %xmm1
	vucomiss	%xmm1, %xmm0
	movq	_gui_config(%rip), %rax
	vcvtsi2ssl	(%rax), %xmm3, %xmm1
	jae	LBB52_7
## %bb.6:
...
LBB64_9:
	...
	vfmadd213ss	%xmm4, %xmm3, %xmm2     ## xmm2 = (xmm3 * xmm2) + xmm4
	movq	16(%r12), %rdi
	addq	$8, %rdi
	...
	vfmadd231ps	%xmm1, %xmm0, %xmm2     ## xmm2 = (xmm0 * xmm1) + xmm2
	vmovlps	%xmm2, -72(%rbp)
	leaq	-72(%rbp), %rsi
	callq	__ZN2sf13Transformable11setPositionERKNS_7Vector2IfEE
	addq	$56, %rsp
