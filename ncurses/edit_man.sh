...
TERMINFO="/Users/thanhduynguyen/Documents/SnakeSenzia/ncurses/build/share/terminfo"
...
(*.[0-9]*)
	...
	if test ! -f "/Users/thanhduynguyen/Documents/SnakeSenzia/ncurses/man_alias.sed" ; then
cat >>/Users/thanhduynguyen/Documents/SnakeSenzia/ncurses/man_alias.sed <<-CF_EOF2
		s,@DATADIR@,$datadir,g
...
s,@TSET@,tset,g
CF_EOF2
		echo "...made /Users/thanhduynguyen/Documents/SnakeSenzia/ncurses/man_alias.sed"
	fi
	...
	aliases=`sed -f "$top_srcdir/man/manlinks.sed" "$inalias" |sed -f "/Users/thanhduynguyen/Documents/SnakeSenzia/ncurses/man_alias.sed" | sort -u; test "$inalias" = "$nCurses" && echo curses`
	...
	sed	-f "/Users/thanhduynguyen/Documents/SnakeSenzia/ncurses/man_alias.sed" \
		< "$i" >$TMP
